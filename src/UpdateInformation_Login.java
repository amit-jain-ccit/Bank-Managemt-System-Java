...
public class UpdateInformation_Login implements ActionListener{
    private final JFrame ShowINfo = new JFrame("Update Information Login");
    ...
    public void design(){
        ...
        ShowINfo.setIconImage(new ImageIcon("C:\\Users\\vijia\\OneDrive\\Desktop\\HeraPheriBank\\src\\Images\\update_Login.png").getImage());
        ...
        try {
            ...
            while(rs.next()){
                if(String.valueOf(rs.getInt(2)).equals(AccNo)){
                    UpdateInformation obj = new UpdateInformation(rs.getString(1),String.valueOf(rs.getInt(2)),String.valueOf(rs.getFloat(3)),String.valueOf(rs.getLong(4)));
                    ShowINfo.setVisible(false);
                    obj.design();
                    return;
                }
